...
#define STRING_CONFIG_H_AUTHOR "(nvip, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NVIP-printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3200, 384 }
